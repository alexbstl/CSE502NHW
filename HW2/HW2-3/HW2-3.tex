...
\end{tabular}
\end{center}
Load Factor = $\frac{4}{8}$ for insertion operations, and $\frac{5}{8}$ for find operations.
\\
\end{enumerate}
...
T.find(38924)
\end{verbatim}
$h_1(38924) = 4$, and $h_2(38924) = 6$.  Because Slot $4$ is full from above, it will return the item stored in that slot.  Note, though that the order of slots is: $4 \to 2 \to 0 \to 6 \to 4...$.
\item
\begin{verbatim}
T.find(62)
\end{verbatim}
